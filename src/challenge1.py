...
urls = []
urls.append("https://vtwnqgwbdg.execute-api.us-west-2.amazonaws.com/prod/eratosthenes128MBAPI")
urls.append("https://vtwnqgwbdg.execute-api.us-west-2.amazonaws.com/prod/eratosthenes256MB_API")
urls.append("https://vtwnqgwbdg.execute-api.us-west-2.amazonaws.com/prod/eratosthenes512API")
urls.append("https://vtwnqgwbdg.execute-api.us-west-2.amazonaws.com/prod/eratosthenes1024MBAPI")
...
# plt.ylabel('Duration (Seconds)')
# plt.savefig('memory_api.png', bbox_inches='tight')
# plt.show()
